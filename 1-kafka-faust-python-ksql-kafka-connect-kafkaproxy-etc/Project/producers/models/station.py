...
class Station(Producer):
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        return f"Station {self.name} - Direction A: leaving to {self.dir_a.name if self.dir_a is not None else '-'}" \
               f" Direction B: leaving to {self.dir_b.name if self.dir_b is not None else '-'}".format(
            self.station_id,
            self.name,
