    ...
    p = Producer(
        {
            ...
            "compression.type" : "lz4",  # other opts: gzip, snappy, zstd
            "linger.ms" : "500", # this is the default value
            "batch.num.messages" : "10000", # this first 2 is what makes it go to kafka, first importance
            "queue.buffering.max.messages" : "1000000", # this is secondary and independent
            "queue.buffering.max.kbytes" : "1048576" # this is secondary and independent, if above is not met this one won't be able to happen
            })
